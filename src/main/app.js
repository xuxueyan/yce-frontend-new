define(['angular', 'angularRouter', 'ngNotify', 'angularAnimate', 'api', 'utils', 'repeatFinished', 'ngLoading', 'ngWindow', 'ngSilder', 'ngPaging'], function(angular){

    var yceMain = angular.module('yceMain',['ngRoute', 'atomic-notify', 'ngAnimate', 'repeatFinished', 'ngLoading', 'ngWinodw', 'rzModule', 'paging']);
    ...
    yceMain.config(['$routeProvider', '$controllerProvider', function ($routeProvider, $controllerProvider){
        ...
        $routeProvider
            ...
            .when('/walkthrogh',{
                templateUrl: 'views/walkthrogh.html',
                controller: 'walkthroghCtrl',
                resolve: {
                    delay: ctrlRegister('walkthroghCtrl',['controllers/walkthrogh.js'])
                }
            })
